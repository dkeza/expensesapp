...
func (v IncomesResource) List(c buffalo.Context) error {
	...
	return c.Render(200, r.Auto(c, incomes))
}
...
func (v IncomesResource) Show(c buffalo.Context) error {
	...
	return c.Render(200, r.Auto(c, income))
}
...
func (v IncomesResource) New(c buffalo.Context) error {
	return c.Render(200, r.Auto(c, &models.Income{}))
}
...
func (v IncomesResource) Create(c buffalo.Context) error {
	...
	if verrs.HasAny() {
		...
		// correct the input.
		return c.Render(422, r.Auto(c, income))
	}

	// If there are no errors set a success message
	c.Flash().Add("success", T.Translate(c, "income.created.success"))
	// and redirect to the incomes index page
	return c.Render(201, r.Auto(c, income))
}
...
func (v IncomesResource) Update(c buffalo.Context) error {
	...
	// If there are no errors set a success message
	c.Flash().Add("success", T.Translate(c, "income.updated.success"))
	// and redirect to the incomes index page
	return c.Render(200, r.Auto(c, income))
}
...
func (v IncomesResource) Destroy(c buffalo.Context) error {
	...
	c.Flash().Add("success", T.Translate(c, "income.destroyed.success"))
